...
cur_dir=$(pwd)
xrayr_repo="Cnievana/XrayR"
xrayr_release_repo="Cnievana/XrayR-release"
...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -q -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://github.com/${xrayr_repo}/releases/download/${last_version}/XrayR-linux-${arch}.zip
        if [[ $? -ne 0 ]]; then
    ...
    file="https://github.com/${xrayr_release_repo}/raw/main/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/${xrayr_release_repo}/main/XrayR.sh
